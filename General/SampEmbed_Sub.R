SampEmbedSub=function(Embedding,rawFeat,ModalityLabel,kk,ClNum,sampInds){
#for sampling a subset of the modalitites so that we can look at parwise
#give the indics in sampInds
library('foreach')
library('doParallel')
library('igraph')
library('FastKNN')
