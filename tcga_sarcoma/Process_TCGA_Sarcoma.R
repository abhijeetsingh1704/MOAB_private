...
#RPPA_analyte
RPPA_analyte=read.csv('Human__TCGA_SARC__MDA__RPPA__MDA_RPPA__01_28_2016__BI__Analyte__Firehose_RPPA.csv',header=TRUE,stringsAsFactors=FALSE)
rownames(RPPA_analyte)=RPPA_analyte[,1]
RPPA_analyte=RPPA_analyte[,-1]

#RPPA_gene
RPPA_gene=read.csv('Human__TCGA_SARC__MDA__RPPA__MDA_RPPA__01_28_2016__BI__Gene__Firehose_RPPA.csv',header=TRUE,stringsAsFactors=FALSE)
rownames(RPPA_gene)=RPPA_gene[,1]
RPPA_gene=RPPA_gene[,-1]

#RNA seq
RNASeq=read.csv('Human__TCGA_SARC__UNC__RNAseq__HiSeq_RNA__01_28_2016__BI__Gene__Firehose_RSEM_log2.csv',header=TRUE,stringsAsFactors=FALSE)
rownames(RNASeq)=RNASeq[,1]
RNASeq=RNASeq[,-1]

#miRNA
miRNA=read.csv('Human__TCGA_SARC__BDGSC__miRNASeq__HS_miR__01_28_2016__BI__Gene__Firehose_RPM_log2.csv',header=TRUE,stringsAsFactors=FALSE)
